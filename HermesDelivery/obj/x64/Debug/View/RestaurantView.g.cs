#pragma checksum "C:\Users\Phano\Documents\GitHub\HermesDelivery\HermesDelivery\View\RestaurantView.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "631577E4811F188B3F44840B684EBBFF"
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IRestaurantView_Bindings
        {
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 20 && columnNumber == 93)
                {
            ...
            private void Update_restaurantViewModel(global::HermesDelivery.ViewModel.RestaurantViewModel obj, int phase)
            {
                ...
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        this.Update_restaurantViewModel_SelectedKurvItem(obj.SelectedKurvItem, phase);
                    }
                    ...
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_restaurantViewModel_OC_Kurv(obj.OC_Kurv, phase);
                    }
                }
            }
            private void Update_restaurantViewModel_SelectedKurvItem(global::HermesDelivery.Model.MenuItem obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
            ...
            private void Update_restaurantViewModel_OC_Kurv(global::System.Collections.ObjectModel.ObservableCollection<global::HermesDelivery.Model.MenuItem> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void UpdateTwoWay_2_SelectedItem()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        ...
                        {
                            this.dataRoot.restaurantViewModel.SelectedKurvItem = (global::HermesDelivery.Model.MenuItem)this.obj2.SelectedItem;
                        }
                    }
                }
            }
                ...
                public void PropertyChanged_restaurantViewModel(object sender, global::System.ComponentModel.PropertyChangedEventArgs e)
                {
                    ...
                    if (bindings != null)
                    {
                        ...
                        if (global::System.String.IsNullOrEmpty(propName))
                        {
                            if (obj != null)
                            {
                                bindings.Update_restaurantViewModel_SelectedKurvItem(obj.SelectedKurvItem, DATA_CHANGED);
